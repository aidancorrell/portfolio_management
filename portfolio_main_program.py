...
#### WORK IN PROGRESS #### visualize first ticker's daily returns over the series
...
#sns.displot(returnsdf[ticker1], kind='kde', color='g')
#sns.displot(returnsdf[ticker1], kind='hist', color='g')
